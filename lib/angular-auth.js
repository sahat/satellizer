  ...
  angular.module('ngAuth', []).provider('$auth', function() {
    ...
    this.$get = function($interval, $http, $location, $rootScope, $q, $window) {
      ...
      return {
        ...
        login: function(user) {
          if (!user) throw new Error('User object cannot be undefined.')
          var deferred = $q.defer();
