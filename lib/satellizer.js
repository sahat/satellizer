...
(function(window, angular, undefined) {
  ...
  var Satellizer = angular.module('Satellizer', []);

  Satellizer.provider('$auth', function() {

    this.config = config;

    // Configures an existing provider by supplying additional information
    // such as scope, clientId, redirectUri and other options.
  ...
  Satellizer.factory('authInterceptor', function($q, $window, $location) {
    return {
  ...
  Satellizer.config(function($httpProvider) {
    $httpProvider.interceptors.push('authInterceptor');
  });

  Satellizer.run(function($rootScope, $window, $location) {
